...
export const Hero = () => {
  return (
    ...
    <div className="container relative">
      ...
      <p className='text-xl text-center mt-8 max-w-md'>Transforming ideas into powerful digital products. At Devixa Technologies, we specialize in crafting custom software, web apps, and enterprise solutions that drive business success.</p>
      </div>
      <div className="flex justify-center mt-8">
